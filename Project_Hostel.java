...
class SDisplayh extends JDialog implements ActionListener {
    ...
    String[] colhed = new String[] {"Hostelid", "Hostelname", "Roomcount", "Floorcount"};
    Object[][] arr = null;
    ...
    SDisplayh(JFrame t, Connection con, String str, boolean state) {
        ...
        b2 = new JButton("Sort by Hostel Name");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (b == b4) {
            ...
            if (b == b1) {
                query = "SELECT * FROM Hostel ORDER BY Hostelid";
            } else if (b == b2) {
                query = "SELECT * FROM Hostel ORDER BY Hostelname";
            }
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    dtm.addRow(new Object[]{rs.getString("Hostelid"), rs.getString("Hostelname"),rs.getInt("Roomcount"), rs.getInt("Floorcount")});
                }
...
public class Project_Hostel extends JFrame implements ActionListener, FocusListener {
    Connection con;
    JPanel p1, p2;
    ...
    Project_Hostel(Connection con) {
        super("Hostel Management");
        this.con = con;

        l3 = new JLabel("Hostel ID: ");
        l3.setBounds(40, 50, 100, 40);
        t3 = new JTextField(6);
        t3.setBounds(140, 50, 250, 30);

        l4 = new JLabel("Hostel Name: ");
        ...
        r1.setBounds(140, 150, 80, 30);
        r2.setBounds(220, 150, 80, 30);

        l6 = new JLabel("Room count: ");
        l6.setBounds(40, 200, 100, 40);
        t5 = new JTextField(30);
        t5.setBounds(140, 200, 250, 30);

        l7 = new JLabel("Floor count: ");
        l7.setBounds(40, 250, 100, 40);
        t6 = new JTextField(30);
        t6.setBounds(140, 250, 250, 30);
        ...
        p1.add(t6);
        b1 = new JButton("Add");
        b1.setBounds(35, 320, 80, 24);

        b2 = new JButton("Modify");
        b2.setBounds(125, 320, 80, 24);

        b3 = new JButton("Delete");
        b3.setBounds(215, 320, 80, 24);

        b4 = new JButton("Display");
        b4.setBounds(305, 320, 80, 24);
    ...
    public void focusLost(FocusEvent e) {
        ...
        if (t == t3) {
            try {
                ...
                PreparedStatement ps = con.prepareStatement("SELECT * FROM hostel WHERE hostelid=?");
                ps.setInt(1, no);
                rs = ps.executeQuery();

                if (rs.next()) {
                    tnm = rs.getString("hostelname");
                    t4.setText(tnm);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (b == b1) {
            ...
            new SDisplayh(this, con, "Hostel Display", true);
        }
        t3.setText("");
        t4.setText("");
        t3.requestFocus();
    ...
    void addRecord() {
        try {
            PreparedStatement ps = con.prepareStatement("INSERT INTO Hostel (Hostelid, Hostelname, roomcount, floorcount) VALUES (?, ?, ?, ?)");
    ...
    void modifyRecord() {
        try {
            PreparedStatement ps = con.prepareStatement("UPDATE Hostel SET Hostelname=?, roomcount=?, floorcount=? WHERE Hostelid=?");
    ...
    void deleteRecord() {
        try {
            PreparedStatement ps = con.prepareStatement("DELETE FROM Hostel WHERE Hostelid=?");
            ps.setString(1, (t3.getText()));
            ps.executeUpdate();
        } catch (SQLException e) {
